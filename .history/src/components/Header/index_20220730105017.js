        ...
        <ul className="items-stretch hidden space-x-3 lg:flex">
          <li className="flex">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "flex items-center px-4 -mb-1 border-b-2 dark:border-transparent transition duration-500 dark:text-white-400 dark:border-violet-400"
          ...
          <li className="flex">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "flex items-center px-4 -mb-1 border-b-2 dark:border-transparent transition duration-500 dark:text-violet-400 dark:border-violet-400"
                  : "flex items-center px-4 -mb-1 border-b-2 dark:border-transparent"
              }
            >
              {t("Liên Hệ")}
